          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                Apprenti en <span style={{ color: 'var(--color-text)' }}>Data</span>, en <span className="gradient-text">automatisation</span> et en <span style={{ color: 'var(--color-text)' }}>IA appliquée</span>.
              </p>
      ...
      <section style={{ borderTop: '1px solid var(--color-border)', padding: '72px 0', backgroundColor: 'var(--color-bg)' }}>
        <div className="container">
          <div style={{
            ...
            {[
              { title: "Données & Décisionnel", items: ["SQL (PostgreSQL, MySQL)", "Power BI", "Modélisation relationnelle", "Migration de bases", "Processus ETL & Nettoyage"] },
